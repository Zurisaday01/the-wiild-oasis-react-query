...
function CheckinBooking() {
	...
	// if you are reviewing your booking and it was paid, then when you open the page you shoud see the checkbox checked
			...
			{!hasBreakfast && (
				<Box>
					<Checkbox
						...
						id='breakfast'>
						Want to add some breakfast for{' '}
